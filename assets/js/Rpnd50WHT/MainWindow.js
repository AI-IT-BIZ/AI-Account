Ext.define('Account.Rpnd50WHT.MainWindow', {
	...
	initComponent : function() {
		...
		this.form = Ext.create('Account.Rpnd50WHT.Form',{ region:'center' });

		this.previewDialog = Ext.create('Account.Rpnd50WHT.PreviewWindow');
