Ext.define('Account.OtherIncome.Item.Window', {
	...
	initComponent : function() {
		...
		this.form = Ext.create('Account.OtherIncome.Item.Form',{ region:'center' });

		this.previewDialog = Ext.create('Account.OtherIncome.Item.PreviewWindow');
