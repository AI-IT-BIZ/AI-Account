Ext.define('Account.RAP.MainWindow', {
	extend	: 'Ext.window.Window',

	constructor:function(config) {

		Ext.apply(this, {
			title: 'Account Payable Selection',
			closeAction: 'hide',
			height: 250,
			width: 500,
			layout: 'border',
	...
	initComponent : function() {
		...
		this.itemDialog = Ext.create('Account.RAP.Item.Window');

		this.form = Ext.create('Account.RAP.Form',{ region:'center' });
		...
		this.itemDialog.on('export_exel_click', function(dialog){
			...
			window.location = __site_url+'export/rap/index?'+query;
		}, this);
