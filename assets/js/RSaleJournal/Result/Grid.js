...
Ext.define('Account.RSaleJournal.Result.Grid', {
	...
	initComponent:function(config) {
		...
		this.columnsGrid = [
			{text: 'AR Date', sortable: false, dataIndex: 'bldat', renderer: Ext.util.Format.dateRenderer('d/m/Y')},
			{text: 'AR Number', sortable: false, dataIndex: 'belnr', filterable:true, filter: {type: 'string'}},
		...
		this.tbar = [{
			...
			handler: function(){
				...
				comid = 1000;
				params = "start_date="+start_date+"&end_date="+end_date+"&kunnr="+kunnr+"&comid="+comid;
				window.location = __base_url + 'index.php/rsalejournal/excel?'+params;
			}
		}];
