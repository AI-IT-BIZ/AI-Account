Ext.define('Account.VendType.MainWindow', {
	...
	initComponent : function() {
		...
		this.addAct = new Ext.Action({
			...
			disabled: !UMS.CAN.CREATE('VT')
		});
		this.editAct = new Ext.Action({
			text: 'Edit',
			iconCls: 'b-small-pencil',
			disabled: !(UMS.CAN.CREATE('VT') || UMS.CAN.EDIT('VT') || UMS.CAN.APPROVE('VT'))
		});
		this.displayAct = new Ext.Action({
			text: 'Display',
			iconCls: 'b-small-search',
			disabled: !UMS.CAN.DISPLAY('VT')
		});
		...
		this.itemDialog = Ext.create('Account.VendType.Item.Window');
		
		//this.importDialog = Ext.create('Account.CustType.Import.Window');

		this.grid = Ext.create('Account.VendType.Grid', {
			region:'center',
			border: false,
		...
		this.addAct.setHandler(function(){
			...
			_this.itemDialog.setTitle('Create Vendor Type');
			/*
		...
		this.editAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setReadOnly(false);
				_this.itemDialog.setTitle('Edit Vendor Type');
				//_this.itemDialog.show();
		...
		this.displayAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setTitle('Display Vendor Type');
			}
		});
