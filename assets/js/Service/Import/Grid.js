Ext.define('Account.Service.Import.Grid', {
	...
	initComponent : function() {
		...
		this.store = new Ext.data.JsonStore({
			proxy: {
				type: 'ajax',
				url: __site_url+"import/service/read",
				reader: {
					type: 'json',
					root: 'rows',
					idProperty: 'row_id'
		...
		this.columns = [{
			...
			{text: "Service Code", width: 100, align: 'center',		dataIndex: 'matnr', sortable: false},
			{text: "Service Name", width: 150, align: 'center',		dataIndex: 'maktx', sortable: false},
			{text: "Service Group", width: 100, align: 'center',		dataIndex: 'matkl', sortable: false},
			{text: "Service Type", width: 80, align: 'center',		dataIndex: 'mtart', sortable: false},
	...
	importData: function(){
		...
		if(rs.length>0){
			...
			Ext.Ajax.request({
				url: __site_url+'import/service/import',
				params: {
					data: data_json
				},
