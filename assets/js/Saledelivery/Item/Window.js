Ext.define('Account.Saledelivery.Item.Window', {
	...
	initComponent : function() {
		...
		this.form = Ext.create('Account.Saledelivery.Item.Form',{ region:'center' });

		this.previewDialog = Ext.create('Account.Saledelivery.Item.PreviewWindow');
		...
		this.btnSave = Ext.create('Ext.Button', {
			text: 'Save',
			disabled: !(UMS.CAN.CREATE('DO') || UMS.CAN.EDIT('DO')||UMS.CAN.APPROVE('SO')),
			handler: function() {
				_this.form.save();
			}
		});
	...
	openDialog: function(id){
		if(id){
			...
			this.form.gridItem.load({delnr: id});
