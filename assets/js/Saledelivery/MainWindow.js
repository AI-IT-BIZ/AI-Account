Ext.define('Account.Saledelivery.MainWindow', {
	 ...
	 /*****************************************************/
      ...
      /*****************************************************/
		...
		this.addAct = new Ext.Action({
			...
			disabled: !UMS.CAN.CREATE('DO')
		});
		this.editAct = new Ext.Action({
			text: 'Edit',
			iconCls: 'b-small-pencil',
			disabled: !(UMS.CAN.DISPLAY('DO') || UMS.CAN.CREATE('DO') || UMS.CAN.EDIT('SO'))
		});
		this.displayAct = new Ext.Action({
			text: 'Display',
			iconCls: 'b-small-search',
			disabled: !UMS.CAN.DISPLAY('DO')
		});
		this.deleteAct = new Ext.Action({
			text: 'Delete',
			iconCls: 'b-small-minus',
			disabled: !UMS.CAN.DELETE('DO')
		});
        this.excelAct = new Ext.Action({
			text: 'Excel',
			iconCls: 'b-small-excel',
			disabled: !UMS.CAN.EXPORT('DO')
		});
        ...
        this.itemDialog = Ext.create('Account.Saledelivery.Item.Window');
        
		this.grid = Ext.create('Account.Saledelivery.Grid', {
			region:'center',
			border: false,
		...
		this.searchForm = Ext.create('Account.Saledelivery.FormSearch', searchOptions);
		...
		this.addAct.setHandler(function(){
			...
			_this.itemDialog.setTitle('Create Delivery Order');
		...
		this.editAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setTitle('Edit Delivery Order');
			}
		});
		...
		this.displayAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setTitle('Display Delivery Order');
			}
		});
		...
		this.itemDialog.form.on('afterSave', function(form, action){
			...
			Ext.Msg.alert('Status', 'Save DO number: '+resultId+' successfully.');
		});
	    ...
	    this.excelAct.setHandler(function(){
			...
			window.location = __site_url+'export/saledelivery/index?'+query;
		});
