Ext.define('Account.SDepositIn.MainWindow', {
	...
	initComponent : function() {
		...
		this.grid = Ext.create('Account.SDepositIn.Grid', {
			region:'center',
			border: false,
		...
		this.searchForm = Ext.create('Account.SDepositIn.FormSearch', searchOptions);
