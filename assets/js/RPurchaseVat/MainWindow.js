Ext.define('Account.RPurchaseVat.MainWindow', {
	extend	: 'Ext.window.Window',

	constructor:function(config) {

		Ext.apply(this, {
			title: 'Purchase Vat Report Selection',
			closeAction: 'hide',
			height: 150,
			width: 350,
			layout: 'border',
	...
	initComponent : function() {
		...
		this.form = Ext.create('Account.RPurchaseVat.Form',{ region:'center' });

		this.previewDialog = Ext.create('Account.RPurchaseVat.PreviewWindow');
