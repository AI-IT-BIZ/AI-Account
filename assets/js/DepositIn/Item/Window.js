Ext.define('Account.DepositIn.Item.Window', {
	...
	initComponent : function() {
		...
		this.form = Ext.create('Account.DepositIn.Item.Form',{ region:'center' });

		this.previewDialog = Ext.create('Account.DepositIn.Item.PreviewWindow');
