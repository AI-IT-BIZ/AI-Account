Ext.define('Account.CustType.MainWindow', {
	...
	initComponent : function() {
		...
		this.addAct = new Ext.Action({
			...
			disabled: !UMS.CAN.CREATE('CT')
		});
		this.editAct = new Ext.Action({
			text: 'Edit',
			iconCls: 'b-small-pencil',
			disabled: !(UMS.CAN.CREATE('CT') || UMS.CAN.EDIT('CT') || UMS.CAN.APPROVE('CT'))
		});
		this.displayAct = new Ext.Action({
			text: 'Display',
			iconCls: 'b-small-search',
			disabled: !UMS.CAN.DISPLAY('CT')
		});
		...
		this.itemDialog = Ext.create('Account.CustType.Item.Window');
		
		//this.importDialog = Ext.create('Account.CustType.Import.Window');

		this.grid = Ext.create('Account.CustType.Grid', {
			region:'center',
			border: false,
		...
		this.addAct.setHandler(function(){
			...
			_this.itemDialog.setTitle('Create Customer Type');
			/*
		...
		this.editAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setReadOnly(false);
				_this.itemDialog.setTitle('Edit Customer Type');
				//_this.itemDialog.show();
		...
		this.displayAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setTitle('Display Customer Type');
			}
		});
