Ext.define('Account.RPR.MainWindow', {
	extend	: 'Ext.window.Window',

	constructor:function(config) {

		Ext.apply(this, {
			title: 'Purchase Requisitions Selection',
			closeAction: 'hide',
			height: 250,
			width: 500,
			layout: 'border',
	...
	initComponent : function() {
		...
		this.itemDialog = Ext.create('Account.RPR.Item.Window');

		this.form = Ext.create('Account.RPR.Form',{ region:'center' });
