Ext.define('Account.AssetGrp.MainWindow', {
	...
	initComponent : function() {
		...
		this.addAct = new Ext.Action({
			...
			disabled: !UMS.CAN.CREATE('FG')
		});
		this.editAct = new Ext.Action({
			text: 'Edit',
			iconCls: 'b-small-pencil',
			disabled: !(UMS.CAN.CREATE('FG') || UMS.CAN.EDIT('FG') || UMS.CAN.APPROVE('FG'))
		});
		this.displayAct = new Ext.Action({
			text: 'Display',
			iconCls: 'b-small-search',
			disabled: !UMS.CAN.DISPLAY('FG')
		});
		...
		this.itemDialog = Ext.create('Account.AssetGrp.Item.Window');
		
		//this.importDialog = Ext.create('Account.CustType.Import.Window');

		this.grid = Ext.create('Account.AssetGrp.Grid', {
			region:'center',
			border: false,
		...
		this.addAct.setHandler(function(){
			...
			_this.itemDialog.setTitle('Create Asset Group');
			/*
		...
		this.editAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setReadOnly(false);
				_this.itemDialog.setTitle('Edit Asset Group');
				//_this.itemDialog.show();
		...
		this.displayAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setTitle('Display Asset Group');
			}
		});
