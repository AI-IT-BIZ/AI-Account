Ext.define('Account.RGR.MainWindow', {
	extend	: 'Ext.window.Window',

	constructor:function(config) {

		Ext.apply(this, {
			title: 'Goods Receipts Selection',
			closeAction: 'hide',
			height: 250,
			width: 500,
			layout: 'border',
	...
	initComponent : function() {
		...
		this.itemDialog = Ext.create('Account.RGR.Item.Window');

		this.form = Ext.create('Account.RGR.Form',{ region:'center' });
