Ext.define('Account.AssetType.MainWindow', {
	...
	initComponent : function() {
		...
		this.addAct = new Ext.Action({
			...
			disabled: !UMS.CAN.CREATE('FT')
		});
		this.editAct = new Ext.Action({
			text: 'Edit',
			iconCls: 'b-small-pencil',
			disabled: !(UMS.CAN.CREATE('FT') || UMS.CAN.EDIT('FT') || UMS.CAN.APPROVE('FT'))
		});
		this.displayAct = new Ext.Action({
			text: 'Display',
			iconCls: 'b-small-search',
			disabled: !UMS.CAN.DISPLAY('FT')
		});
		...
		this.itemDialog = Ext.create('Account.AssetType.Item.Window');
		
		//this.importDialog = Ext.create('Account.CustType.Import.Window');

		this.grid = Ext.create('Account.AssetType.Grid', {
			region:'center',
			border: false,
		...
		this.addAct.setHandler(function(){
			...
			_this.itemDialog.setTitle('Create Asset Type');
			/*
		...
		this.editAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setReadOnly(false);
				_this.itemDialog.setTitle('Edit Asset Type');
				//_this.itemDialog.show();
		...
		this.displayAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setTitle('Display Asset Type');
			}
		});
