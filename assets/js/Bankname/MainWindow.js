Ext.define('Account.Bankname.MainWindow', {
	...
	initComponent : function() {
		...
		this.addAct = new Ext.Action({
			...
			disabled: !UMS.CAN.CREATE('BN')
		});
		this.editAct = new Ext.Action({
			text: 'Edit',
			iconCls: 'b-small-pencil',
			disabled: !(UMS.CAN.CREATE('BN') || UMS.CAN.EDIT('BN') || UMS.CAN.APPROVE('BN'))
		});
		this.displayAct = new Ext.Action({
			text: 'Display',
			iconCls: 'b-small-search',
			disabled: !UMS.CAN.DISPLAY('BN')
		});
		...
		this.grid = Ext.create('Account.Bankname.Grid', {
			region:'center',
			border: false,
		...
		this.addAct.setHandler(function(){
			...
			_this.itemDialog.setTitle('Create Bank Name');
			/*
		...
		this.editAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setReadOnly(false);
				_this.itemDialog.setTitle('Edit Bank Name');
				//_this.itemDialog.show();
		...
		this.displayAct.setHandler(function(){
			...
			if(id){
				...
				_this.itemDialog.setTitle('Display Bank Name');
			}
		});
