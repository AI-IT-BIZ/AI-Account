Ext.define('Account.RPO.MainWindow', {
	extend	: 'Ext.window.Window',

	constructor:function(config) {

		Ext.apply(this, {
			title: 'Purchase Orders Selection',
			closeAction: 'hide',
			height: 250,
			width: 500,
			layout: 'border',
	...
	initComponent : function() {
		...
		this.itemDialog = Ext.create('Account.RPO.Item.Window');

		this.form = Ext.create('Account.RPO.Form',{ region:'center' });
