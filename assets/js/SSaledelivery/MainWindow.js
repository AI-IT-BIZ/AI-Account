Ext.define('Account.SSaledelivery.MainWindow', {
	...
	initComponent : function() {
		...
		this.grid = Ext.create('Account.SSaledelivery.Grid', {
			region:'center',
			border: false,
		...
		this.searchForm = Ext.create('Account.SSaledelivery.FormSearch', searchOptions);
