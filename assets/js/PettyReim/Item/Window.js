Ext.define('Account.PettyReim.Item.Window', {
	extend	: 'Ext.window.Window',
	constructor:function(config) {

		Ext.apply(this, {
			title: 'Create/Edit Petty Cast Reimbursement',
			closeAction: 'hide',
			height: 670,
			width: 940,
			layout: 'border',
	...
	initComponent : function() {
		...
		this.form = Ext.create('Account.PettyReim.Item.Form',{ region:'center' });

		this.previewDialog = Ext.create('Account.PettyReim.Item.PreviewWindow');
		...
		this.btnSave = Ext.create('Ext.Button', {
			text: 'Save',
			disabled: !(UMS.CAN.CREATE('CPV') || UMS.CAN.EDIT('CPV')||UMS.CAN.APPROVE('CPV')),
			handler: function() {
				_this.form.save();
			}
		});
