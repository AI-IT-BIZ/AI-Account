...
class GR extends CI_Controller {
	...
	function index()
	{
	    ...
	    $strSQL = " select v_mkpf.*,v_mseg.*";
        $strSQL = $strSQL . " from v_mkpf ";
        $strSQL = $strSQL . " left join v_mseg on v_mkpf.mbeln = v_mseg.mbeln ";
        $strSQL = $strSQL . " Where v_mkpf.mbeln = '$no'  ";
        $strSQL .= "ORDER BY mbelp ASC";
...
<div style="left: 460PX; top: 295px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 51px;">
<table width="0px" height="64PX"><td>&nbsp;</td></table>
</div>
<div style="left: 602PX; top: 295px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 51px;">
<table width="0px" height="64PX"><td>&nbsp;</td></table>
</div>
...
<!--Header Text-->
<DIV style="left:278PX;top:128PX;width:263PX;height:21PX;TEXT-ALIGN:CENTER;"><span class="fc1-0">GOODS RECEIPT</span></DIV>

<DIV style="left:278PX;top:109PX;width:263PX;height:25PX;TEXT-ALIGN:CENTER;"><span class="fc1-0">ใบรับสินค้า/บริการ</span></DIV>
...
<DIV style="left: 122px; top: 267px; width: 26px; height: 21PX;"><span class="fc1-8">Tel.</span></DIV>

<DIV style="left: 287PX; top: 267px; width: 161px; height: 21PX;"><span class="fc1-8">Fax. &nbsp;<?=$r_data['telfx'];?></span></DIV>

<DIV style="left: 150px; top: 269px; width: 133px; height: 21PX;"><span class="fc1-8"><?=$r_data['telf1'];?></span></DIV>

<!--Delivery Place-->
<DIV style="left: 559px; top: 176PX; width: 75PX; height: 20PX;"><span class="fc1-2">เลขที่ (No.)</span></DIV>

<DIV style="left: 634px; top: 174PX; width: 109px; height: 25PX;"><span class="fc1-3"><?=$r_data['mbeln'];?></span></DIV>
...
<DIV style="left: 276px; top: 298PX; width: 182px; height: 19PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">Reference</span></DIV>

<DIV style="left: 277px; top: 322PX; width: 178px; height: 22PX; TEXT-ALIGN: LEFT;"><span class="fc1-6"><?=$r_data['refnr'];?></span></DIV>

<DIV style="left: 160px; top: 298PX; width: 114px; height: 19PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">Project No</span>.</DIV>

<DIV style="left: 160px; top: 322PX; width: 113px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-6"><?=$r_data['jobnr'];?></span></DIV>
...
?>
	<tr>
		<td class="fc1-8" align="center" style="width:32px;"><?=$item['mbelp'];?></td>
		<td class="fc1-8" align="center" style="width:79px;"><?=$item['matnr'];?></td>
		<td class="fc1-8" align="left" style="width:224px;"><?=$item['maktx'];?></td>
		<td class="fc1-8" align="right" style="width:75px;"><?=number_format($item['upqty'],2,'.',',');?></td>
...
<DIV style="left:49PX;top:1059PX;width:47PX;height:19PX;TEXT-ALIGN:RIGHT;"><span class="fc1-5">Received by</span></DIV>
