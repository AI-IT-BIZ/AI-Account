...
class Rsumvat extends CI_Controller {
	...
	function index()
	{
		...
		//Sale
	    $strSQL1 = " select v_vbbk.*";
        $strSQL1 = $strSQL1 . " from v_vbbk ";
        $strSQL1 = $strSQL1 . " Where v_vbbk.bldat ".$dt_result;
...
<div style="left: 555px; top: 156px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 504px;">
  <table width="0px" height="205PX"><td>&nbsp;</td></table>
</div>

<DIV style="left: 54px; top: 158px; width: 108px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">เลขที่ประจำตัว</span></DIV>
<DIV style="left: 53px; top: 181px; width: 109px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">ผู้เสียภาษีอากร</span></DIV>

<DIV style="left: 555px; top: 170px; width: 63px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">สาขา</span></DIV>

<div style="left: 162px; top: 156px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 504px;">
  <table width="0px" height="205PX"><td>&nbsp;</td></table>
</div>
<DIV style="left: 163px; top: 169px; width: 133px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">ชื่อ</span></DIV>

<div style="left: 297px; top: 157px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 503px;">
  <table width="0px" height="205PX"><td>&nbsp;</td></table>
</div>

<DIV style="left: 299px; top: 169px; width: 256px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">ที่ตั้งสถานประกอบการ</span></DIV>

<div style="left: 617px; top: 157px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 504px;">
  <table width="0px" height="205PX"><td>&nbsp;</td></table>
</div>

<DIV style="left: 618px; top: 157px; width: 75px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">วัน เดือน ปี</span></DIV>

<DIV style="left: 618px; top: 180px; width: 75px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">ที่จ่าย</span></DIV>

<DIV style="left: 696px; top: 158px; width: 50px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">ประเภท</span></DIV>

<DIV style="left: 694px; top: 178px; width: 50px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">เงินได้</span></DIV>

<div style="left: 744px; top: 157px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 504px;">
  <table width="0px" height="205PX"><td>&nbsp;</td></table>
</div>

<DIV style="left: 743px; top: 158px; width: 56px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">อัตราภาษี</span></DIV>

<DIV style="left: 746px; top: 182px; width: 56px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">ร้อยละ</span></DIV>

<DIV style="left: 802px; top: 167px; width: 130px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">จำนวนเงินที่ได้รับ</span></DIV>

<div style="left: 800px; top: 157px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 504px;">
  <table width="0px" height="205PX"><td>&nbsp;</td></table>
</div>

<div style="left: 693px; top: 156px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 505px;">
  <table width="0px" height="205PX"><td>&nbsp;</td></table>
</div>
...
<DIV style="left: 934px; top: 157px; width: 142px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">จำนวนเงินภาษีที่หัก</span></DIV>

<DIV style="left: 962px; top: 180px; width: 80px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-5">และนำส่งในครั้งนี้</span></DIV>
...
?>
	<tr>
	  ...
	  <td class="fc1-8" align="center" style="width:111px;"><?=$item['taxid'];?></td>
	  <td class="fc1-8" align="left" style="width:136px;"><?=$item['name1'];?></td>
      <td class="fc1-8" align="left" style="width:255px;"><?=$adr01;?></td>
	  <td class="fc1-8" align="center" style="width:58px;">0000</td>
	  <td class="fc1-8" align="center" style="width:75px;"><?=$duedt_str;?></td>
      <td class="fc1-8" align="center" style="width:53px;">01</td>
      <td class="fc1-8" align="center" style="width:56px;"><?=$item['whtpr'];?></td>
      <td class="fc1-8" align="right" style="width:130px;"><?=$item['beamt'];?></td>
	  <td class="fc1-8" align="right" style="width:142px;"><?=$item['wht01'];?></td>
	</tr>
...
<DIV style="left: 863px; top: 661px; width: 71px; height: 22PX; TEXT-ALIGN: RIGHT;"><span class="fc1-1"><?= check_page($current_page_index, $total_page, number_format($total1,2,'.',',')) ?></span></DIV>
<DIV style="left:975PX;top:660PX;width:84PX;height:22PX;TEXT-ALIGN:RIGHT;"><span class="fc1-1"><?= check_page($current_page_index, $total_page, number_format($total2,2,'.',',')) ?></span></DIV>
