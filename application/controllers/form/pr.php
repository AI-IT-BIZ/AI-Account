...
<table width="0px" height="50PX"><td>&nbsp;</td></table>
</div>
...
<DIV style="left: 635px; top: 174PX; width: 109px; height: 25PX;"><span class="fc1-3"><?=$r_data['purnr'];?></span></DIV>

<DIV style="left: 562px; top: 198PX; width: 76PX; height: 20PX;"><span class="fc1-2">วันที่ (Date) </span></DIV>
<?php 
$bldat_str = util_helper_format_date($r_data['bldat']);
?>
<DIV style="left: 636px; top: 196PX; width: 108PX; height: 21PX;"><span class="fc1-3"><?=$bldat_str?></span></DIV>
