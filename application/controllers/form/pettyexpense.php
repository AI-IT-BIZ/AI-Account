...
class Pettyexpense extends CI_Controller {
	...
	function index()
	{
	    ...
	    $strSQL = " select v_ebek.*,v_ebep.*";
        $strSQL = $strSQL . " from v_ebek ";
        $strSQL = $strSQL . " left join v_ebep on v_ebek.invnr = v_ebep.invnr ";
        $strSQL = $strSQL . " Where v_ebek.invnr = '$no'  ";
...
<div style="left: 157PX; top: 296px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 65px;">
<table width="0px" height="64PX"><td>&nbsp;</td></table>
</div>
...
<!--Header Text-->
<DIV style="left:278PX;top:128PX;width:263PX;height:21PX;TEXT-ALIGN:CENTER;"><span class="fc1-0">PETTY CASH</span></DIV>

<DIV style="left:278PX;top:109PX;width:263PX;height:25PX;TEXT-ALIGN:CENTER;"><span class="fc1-0">ใบเบิกจ่ายล่วงหน้า</span></DIV>
...
<!--Delivery Place-->
<DIV style="left: 558px; top: 176PX; width: 75PX; height: 20PX;"><span class="fc1-2">เลขที่ (No.)</span></DIV>

<DIV style="left: 634px; top: 174PX; width: 108px; height: 25PX;"><span class="fc1-3"><?=$r_data['invnr'];?></span></DIV>

<DIV style="left: 558px; top: 198PX; width: 76PX; height: 20PX;"><span class="fc1-2">วันที่ (Date) </span></DIV>
<?php 
$bldat_str = util_helper_format_date($r_data['bldat']);
?>
...
<DIV style="left:49PX;top:298PX;width:108PX;height:19PX;TEXT-ALIGN:CENTER;"><span class="fc1-5">CPV no.</span></DIV>

<DIV style="left:60PX;top:322PX;width:90PX;height:22PX;TEXT-ALIGN:CENTER;"><span class="fc1-6"><?=$r_data['remnr'];?></span></DIV>
