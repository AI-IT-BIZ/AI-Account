...
class PO extends CI_Controller {
	...
	function index()
	{
	    ...
	    $strSQL = " select v_order.*,v_ekpo.*";
        $strSQL = $strSQL . " from v_order ";
        $strSQL = $strSQL . " left join v_ekpo on v_order.ebeln = v_ekpo.ebeln ";
        $strSQL = $strSQL . " Where v_order.ebeln = '$no'  ";
...
<div style="left: 460PX; top: 297px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 62px;">
<table width="0px" height="64PX"><td>&nbsp;</td></table>
</div>
<div style="left: 602PX; top: 296px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 63px;">
<table width="0px" height="64PX"><td>&nbsp;</td></table>
</div>
...
<!--Vendor Name-->
<DIV style="left: 57PX; top: 176PX; width: 68px; height: 22PX;"><span class="fc1-2">ชื่อผู้จำหน่าย</span></DIV>
...
<DIV style="left: 124px; top: 267px; width: 27px; height: 21PX;"><span class="fc1-8">Tel.</span></DIV>

<DIV style="left: 287PX; top: 267px; width: 161px; height: 21PX;"><span class="fc1-8">Fax. &nbsp;<?=$r_data['telfx'];?></span></DIV>

<DIV style="left: 153px; top: 269px; width: 130px; height: 21PX;"><span class="fc1-8"><?=$r_data['telf1'];?></span></DIV>

<!--Delivery Place-->
<DIV style="left: 559px; top: 176PX; width: 75PX; height: 20PX;"><span class="fc1-2">เลขที่ (No.)</span></DIV>

<DIV style="left: 634px; top: 174PX; width: 108px; height: 25PX;"><span class="fc1-3"><?=$r_data['ebeln'];?></span></DIV>
...
<DIV style="left:49PX;top:298PX;width:108PX;height:19PX;TEXT-ALIGN:CENTER;"><span class="fc1-5">PR No.</span></DIV>

<DIV style="left: 53px; top: 322PX; width: 102px; height: 22PX; TEXT-ALIGN: CENTER;"><span class="fc1-6"><?=$r_data['purnr'];?></span></DIV>
...
?>
	<tr>
		<td class="fc1-8" align="center" style="width:32px;"><?=$item['ebelp'];?></td>
...
<DIV style="left: 49PX; top: 1059PX; width: 59px; height: 19PX; TEXT-ALIGN: LEFT;"><span class="fc1-5">Ordered by</span></DIV>
...
<DIV style="left:49PX;top:1041PX;width:183PX;height:19PX;TEXT-ALIGN:CENTER;"><span class="fc1-4">ผู้สั่งซื้อ ............./............../................</span></DIV>
