...
class Purchasecreditnote extends CI_Controller {
	...
	function index()
	{
	    ...
	    $strSQL = " select v_ebcn.*,v_ebcp.*";
        $strSQL = $strSQL . " from v_ebcn ";
        $strSQL = $strSQL . " left join v_ebcp on v_ebcn.crenr = v_ebcp.crenr ";
        $strSQL = $strSQL . " Where v_ebcn.crenr = '$no'  ";
...
<DIV style="left:278PX;top:128PX;width:263PX;height:21PX;TEXT-ALIGN:CENTER;"><span class="fc1-0">CREDIT NOTE</span></DIV>
...
<DIV style="left:635PX;top:111PX;width:112PX;height:25PX;"><span class="fc1-3"><?=$r_data['crenr'];?></span></DIV>
...
<DIV style="left: 109PX; top: 219px; width: 347px; height: 23PX;"><span class="fc1-8"><?=$ads00[1];?></span></DIV>

<DIV style="left: 109PX; top: 243px; width: 346px; height: 22PX;"><span class="fc1-8"><?=$r_data['distx'];?>&nbsp;&nbsp;<?=$r_data['pstlz'];?>&nbsp;&nbsp;เลขประจำตัวผู้เสียภาษี&nbsp;<?=$r_data['taxid'];?></span></DIV>
...
<DIV style="left: 519PX; top: 176px; width: 233px; height: 23PX;"><span class="fc1-8"><?=$ads00[0];?></span></DIV>

<DIV style="left: 519PX; top: 199px; width: 233px; height: 23PX;"><span class="fc1-8"><?=$ads00[1];?></span></DIV>
...
<DIV style="left:49PX;top:298PX;width:108PX;height:19PX;TEXT-ALIGN:CENTER;"><span class="fc1-5">AP no.</span></DIV>
...
<DIV style="left:456PX;top:298PX;width:142PX;height:19PX;TEXT-ALIGN:CENTER;"><span class="fc1-5">Vendor Code</span></DIV>
