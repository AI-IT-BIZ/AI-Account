...
<div style="left: 586px; top: 229px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 850px;">
  <table width="0px" height="305PX"><td>&nbsp;</td></table>
</div>
<div style="left: 549px; top: 229px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 819px;">
  <table width="0px" height="305PX"><td>&nbsp;</td></table>
</div>
...
<div style="left: 420px; top: 229px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 820px;">
  <table width="0px" height="305PX"><td>&nbsp;</td></table>
</div>
<div style="left:49PX;top:270PX;border-color:0000FF;border-style:solid;border-width:0px;border-top-width:1PX;width:705PX;">
</div>
<div style="left: 672px; top: 228px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 851px;">
...
<div style="left: 154px; top: 229px; border-color: 0000FF; border-style: solid; border-width: 0px; border-left-width: 1PX; height: 821px;">
...
<DIV style="left: 672px; top: 31px; width: 78px; height: 25PX;"><span class="fc1-3"><?=($current_page_index+1).'/'.$total_page;?></span></DIV>

<!--Header Text-->
<DIV style="left: 262px; top: 29px; width: 263PX; height: 25PX; TEXT-ALIGN: CENTER;"><span class="fc1-0">รายงานภาษีขาย</span></DIV>
<DIV style="left: 278px; top: 59px; width: 81px; height: 25PX; TEXT-ALIGN: CENTER;"><span class="fc1-1">ประจำเดือน</span></DIV>

<DIV style="left: 355px; top: 59px; width: 87px; height: 25PX; TEXT-ALIGN: LEFT;"><span class="fc1-13"><?= $text_month ?></span></DIV>
...
<DIV style="left: 159px; top: 152px; width: 74px; height: 20PX;"><span class="fc1-3"><?= $r_com['taxid']; ?></span></DIV>
...
?>
<DIV style="left: 357px; top: 178px; width: 60px; height: 21PX;"><span class="fc1-3">0000</span></DIV>
<?php 
$duedt_str = util_helper_format_date($r_data['duedt']);
?>

<!--Company Logo--><!--Company Text-->
<DIV style="left: 414px; top: 129px; width: 214px; height: 20px;"><span class="fc1-5"><?= $r_com['name1']; ?></span></DIV>

<DIV style="left: 129px; top: 128px; width: 248px; height: 20px;"><span class="fc1-5"><?= $r_com['name1']; ?></span></DIV>
...
<DIV style="left: 124px; top: 178px; width: 111px; height: 26PX;"><span class="fc1-3">0000</span></DIV>
...
<DIV style="left: 231px; top: 230PX; width: 190px; height: 19PX; TEXT-ALIGN: CENTER;"><span class="fc1-2">ชื่อผู้ซื้อสินค้า/</span></DIV>
...
<DIV style="left: 594px; top: 1054px; width: 76px; height: 19PX; TEXT-ALIGN: RIGHT;"><span class="fc1-10">
<?= check_page($current_page_index, $total_page, number_format($t_amt,2,'.',',')) ?></span></DIV>
<DIV style="left: 674px; top: 1054px; width: 77px; height: 19PX; TEXT-ALIGN: RIGHT;"><span class="fc1-10">
