<?php
class Rpurchasejournal extends CI_Controller {
	...
	public function pdf(){
		...
		$report = $client->runReport('/ai_account/rpurchasejournal', 'pdf', null, $controls);
	...
	public function excel(){
		...
		$report = $client->runReport('/ai_account/rpurchasejournal', 'xlsx', null, $controls);
